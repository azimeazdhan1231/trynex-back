...
-- Clean migration that matches the current schema exactly
-- Drop all tables and recreate with proper structure
...
-- Create products table matching schema.ts exactly
